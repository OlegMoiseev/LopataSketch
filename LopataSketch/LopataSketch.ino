#include <lsm6-arduino-master\LSM6.h>
#include <lis3mdl-arduino-master\LIS3MDL.h>
...
void loop()
{
  ...
  // Get yaw, pitch and roll angles from filter
...
// If camera at up:
  /*if ( -45 < roll && roll <= 45){
    ...
    if ( 45 < roll && roll <= 135){
      ...
      if ( 135 < roll && roll <= 180 || -180 < roll && roll <= -135){
        digitalWrite(led1, LOW);
